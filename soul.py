...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*VIST CHANNEL FOR HELP & PRICE LIST https://t.me/Danger_hack_ddos*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin @jks6190*", parse_mode='Markdown')
    else:
