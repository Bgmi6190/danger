...
def send_welcome(message):
    ...
    keyboard.add(KeyboardButton("My Account🏦"), KeyboardButton("Help❓"), KeyboardButton("Canary Download✔️"), KeyboardButton("Contact admin✔️"), KeyboardButton("Instant Plan 🧡"), KeyboardButton("Instant++ Plan 💥"))
...
def handle_message(message):
    ...
    elif message.text == "Instant Plan 🧡" or message.text == "Instant++ Plan 💥":
        plan = 1 if message.text == "Instant Plan 🧡" else 2
        bot.send_message(message.chat.id, f"*You have selected the {'Instant Plan' if plan == 1 else 'Instant++ Plan'}.*\n"
