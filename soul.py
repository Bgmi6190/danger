...
import threading  # Import threading for scheduling "Attack finished" message
...
def process_attack_command(message):
    try:
        ...
        # Schedule a message to be sent after the attack duration
...
def send_attack_finished_message(chat_id):
    bot.send_message(chat_id, "*Attack finished!*", parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        if user_data:
            ...
            bot.send_message(message.chat.id, "*No account data found.*", parse_mode='Markdown')
    elif message.text == "Help❓":
        bot.send_message(message.chat.id, "*For help, please contact the admin.*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.send_message(message.chat.id, "*You can contact the admin at @youradminusername*", parse_mode='Markdown')
